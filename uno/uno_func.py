...
Rule = "★ハウスルール(基本的なものは除く)\n" \
       ...
       "2. スキップは[2 x 出した枚数 - 1]人飛ばす\n" \
       "3. リバースを出しても再度自分の番にはならない(3人以上)\n" \
       "4. ドロー4は他に出せるカードがあっても出せる\n" \
       "4-2. ドロー2の後にドロー4で返すことが可能\n" \
       "4-3. ドロー4の後は、ドロー4もしくは指定された色のドロー2のみ返すことが可能\n" \
       "4-4. 一度にドロー2とドロー4を組み合わせて出すことは出来る\n" \
       "5. 山札から引いた後にすぐ出すことができる、そこから手札とコンボを組んでも良い\n" \
       "5-2. ドロー2/4を受けた後でもカードを出すことが出来る\n" \
       "6. 山札から引けるのは1ターンで1枚まで\n" \
       "6-2. 山札から1枚も引かずにパスすることは出来ない(ドロー2/4を受ける場合は除く)\n" \
       "7. 記号で上がることは出来ない(記号しか残っていない時点で2枚追加)\n" \
       "7-2. 手札が2枚以上の状態から、複数枚出しで一気に上がることは出来ない\n" \
       "8. 誰か1人が上がったらその時点でゲームセット\n" \
       "8-2. 数字カードは-その数字点、記号カードは-20点、ワイルドカードは-50点で計算\n" \
       "8-3. 1位は全員のマイナスポイント分をプラスで受け取れる\n\n\n" \
       "★カードの出し方 ※[]内は短縮形\n" \
