...
def id_to_pass(id):
    if 100 <= id < 200:
        return f"./card_image/Red_{id % 100}.png"
    elif 200 <= id < 300:
        return f"./card_image/Blue_{id % 200}.png"
    elif 300 <= id < 400:
        return f"./card_image/Green_{id % 300}.png"
    elif 400 <= id < 500:
        return f"./card_image/Yellow_{id % 400}.png"
    else:
        return f"./card_image/Black_{id % 500}.png"
